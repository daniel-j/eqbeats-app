...
this.App.module("Entities.Player", function(Player, App, Backbone, Marionette, $, _) {
  'use strict';
  var API, aacSource, audioTag, lastAddedId, mp3Source, oggSource, state;
  ...
  audioTag.addEventListener('timeupdate', function() {
    ...
    if (this.currentTime > 5 && state.get('track').get('id') !== lastAddedId) {
      App.execute('track:history:add', state.get('track'));
      return lastAddedId = state.get('track').get('id');
    }
  });
