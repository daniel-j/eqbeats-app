window.GS.tpl = {
    "getapp.ejs": function (obj) {
        ...
        with(obj || {})
        __p += '<a class="get-app" href="http://m.grooveshark.com/?noRedirect" target="_blank">\n    ' + _.getString("GET_APP", {
            platform: platform
    ...
    "shared/release_to_load.ejs": function (obj) {
        ...
        with(obj || {})
        __p += '<li class="list-row list-row-release-to-load"><em data-translate-text="RELEASE_TO_LOAD">' + _.getString("RELEASE_TO_LOAD") + "</em></li>\n";
        return __p
    },
    ...
    "now_playing/queue_actions_edit.ejs": function (obj) {
        ...
        with(obj || {})
        __p += '<li class="menu-gradient button queue-list-action-done" data-translate-text="DONE">' + _.getString("DONE") + "</li>\n";
        return __p
    },
    ...
    "pages/stations/list.ejs": function (obj) {
        ...
        with(obj || {})
        __p += "", _.each(stations, function (e) {
            __p += "\n";
    ...
    "playlists/list.ejs": function (obj) {
        ...
        with(obj || {})
        __p += "", _.each(models, function (e, t) {
            __p += "\n";
            var n = e.attributes,
                r = n.PlaylistID;
    ...
    "song_list/header.ejs": function (obj) {
        ...
        with(obj || {})
        __p += '<span class="submenu-gradient list-header-left button list-header-play-now"><span data-translate-text="PLAY_NUM">' + _.getString("PLAY_NUM", {
            number: count
...
function (e, t) {
    GS.models._Storage = {
        ...
        changeLanguage: function (t) {
            ...
            if (t !== this.lastLang)
                return $("[data-translate-text]").localize("gs", {
                    language: t
        ...
        readCookie: function (e) {
            ...
            for (var n = 0; n < t.length; n++)
                if (encodeURIComponent(e) === t[n][0])
                    return JSON.parse(t[n][1]);
            return null
        }
    };
    var n = function () {};
...
function (e, t) {
    ...
    function p(e) {
        ...
        var n;
        while (r.callsPendingToken.length)
            n = r.callsPendingToken.shift(), n.send()
    }
    ...
    function d(e, t) {
        ...
        var i;
        while (r.callsPendingToken.length)
            i = r.callsPendingToken.shift(), i.reject({
    ...
    i.prototype.queue = function (e) {
        ...
        for (var t = 0; t < this.successFilters.length; t++)
            _.isFunction(this.successFilters[t]) && (e = this.successFilters[t](e));
        this.lastResolution = (new Date).valueOf(), this._dfd.resolve(e)
    }, s.prototype.resolveWith = function (e, t) {
        for (var n = 0; n < this.successFilters.length; n++)
            _.isFunction(this.successFilters[n]) && (t = this.successFilters[n](t));
        this.lastResolution = (new Date).valueOf(), this._dfd.resolveWith(e, t)
    }, s.prototype.reject = function (e) {
        for (var t = 0; t < this.faultFilters.length; t++)
            _.isFunction(this.faultFilters[t]) && (e = this.faultFilters[t](e));
        this._dfd.reject(e)
    }, s.prototype.rejectWith = function (e, t) {
        for (var n = 0; n < this.faultFilters.length; n++)
            _.isFunction(this.faultFilters[n]) && (t = this.faultFilters[n](t));
        ...
        var e, t, n = "";
        for (e in this.cacheKeyProps)
            this.cacheKeyProps.hasOwnProperty(e) && (t = this[this.cacheKeyProps[e]], t instanceof String ? n += t : n += JSON.stringify(t));
        return hex_md5(n)
        ...
        if (r.tokenExpires > s || ["getCommunicationToken", "initiateSession", "getServiceStatus"].indexOf(this.method) != -1) {
            ...
            if (this.method === "getStreamKeyFromSongIDEx" || this.method === "getSongFromToken")
                f.parameters.country = f.header.country;
            if (r.currentToken) {
                var p;
            ...
            this.isPending = !1, r.callsPendingToken.push(this), c()
        ...
        var r, i, o = t.url(e);
        if (!o)
            throw new Error("No endpoint for '" + e + "' method defined in the model");
    ...
    if (e.XDomainRequest) {
        ...
        e.addEventListener("message", function (t) {
            if (t.origin != "https://" + e.location.host)
                return;
            try {
                ...
                if (n.id === 0 && n.data == "loaded") {
                    ...
                    for (var r = 0, i = y.length; r < i; r++)
                        v.postMessage(y[r], "https://" + e.location.host);
                    y = []
                } else
                    n.id && g[n.id] && (g[n.id](n), delete g[n.id])
            } catch (s) {
...
function (e, t) {
    ...
    _.extend(n.prototype, Backbone.Events, {
        ...
        newItem: function (e, n) {
            ...
            n = n || {};
            for (i in n)
                n[i] !== t && (n[i].toString() != "[object Object]" ? r[1][i] = n[i] + "" : console.error("guts: can not use object as log value", e, i));
            for (i in this._context)
                this._context[i] && (r[2][i] = this._context[i]);
            return r
        },
        log: function (e, t) {
        ...
        begin: function (e) {
            if (!this.enabled)
                return this;
            for (var t in e)
                e[t].toString() != "[object Object]" ? (this._context[t] = e[t] + "", this.verbose && console.log("guts: begin", t, this._context[t])) : console.error("guts: can not use object as context value", t, e);
            return this.check()
        },
        end: function () {
            if (!this.enabled)
            ...
            var e = [].slice.call(arguments),
                t;
            while ( !! (t = e.shift()) && this._context.hasOwnProperty(t))
                this.verbose && console.log("guts: end", t), delete this._context[t];
            return this.check()
        },
        check: function (e) {
            if (!this._log.length)
...
function (e, t) {
    ...
    var n = Backbone.Model.extend({
        ...
        set: function (e, t) {
            ...
            if (!r.CoverArtFilename || r.CoverArtFilename === "default.png")
                r.CoverArtFilename = "album.png";
            if (r.Name || r.SongName)
                r.name = r.Name || r.SongName;
        ...
        i = Backbone.Collection.extend({
            ...
            sortBy: function (e) {
                var t, n;
                if (this._sorted && e === this._sorted.field)
                    t = this.models.reverse(), this._sorted.reverse = !this._sorted.reverse;
                else {
                    n = i.comparators[e];
                    if (typeof n == "undefined")
                        throw new Error("Collection doesn't know how to sort itself with '" + e + "'");
    ...
    var o = Backbone.Model.extend({
        initialize: function (e) {
            if (!e.song)
                throw new Error("No idea how to stream song w/o a song.");
...
function (e, t) {
    var n = Backbone.Model.extend({
        ...
        set: function (e, t) {
            ...
            if (e.Name || e.AlbumName)
                e.name = e.Name || e.AlbumName;
...
function (e, t) {
    var n = GS.models.Songs.extend({
        initialize: function (e, t) {
            t = t || {};
            if (!t.userID)
                throw new Error("Can not create Library w/o user id.");
    ...
    var r = GS.models.Songs.extend({
        initialize: function (e, t) {
            t = t || {};
            if (!t.userID)
                throw new Error("Can not create Favorites w/o user id.");
            this.userID = parseInt(t.userID, 10), t.sortBy = "age", GS.models.Songs.prototype.initialize.call(this, e, t)
        },
        url: function (e) {
            return {
    ...
    var i = GS.models.Playlists.extend({
        initialize: function (e, t) {
            t = t || {};
            if (!t.userID)
                throw new Error("Can not fetch user playlists w/o user id");
    ...
    var s = Backbone.Model.extend({
        ...
        o = Backbone.Collection.extend({
            ...
            initialize: function (e, t) {
                if (!t.userID)
                    throw new Error("No idea how to load users following w/o user id");
    ...
    var a = u.extend({
        ...
        isFavorited: function (e) {
            if (!e)
                throw new Error("Can't tell if favorited w/o song");
            return this.authenticated() && this.favorites.length ? !! this.favorites.get(e) : !1
        },
        isAdded: function (e) {
            if (!e)
                throw new Error("Can't tell if added to library w/o song");
...
function (e, t) {
    var n = Backbone.Model.extend({
        ...
        initialize: function (e, t) {
            ...
            if (!this.only)
                this.songs = new GS.models.Songs, this.playlists = new GS.models.Playlists, this.albums = new GS.models.Albums;
            else
                switch (this.only) {
                case "songs":
                    this.songs = new GS.models.Songs;
    ...
    var n = Backbone.Model.extend({
        ...
        r = GS.models.Songs.extend({
            ...
            shuffleFrom: function (e, t) {
                if (!this.preferences.get("shuffle"))
                    return;
                t && this.reshuffle();
                var n = e.cid,
            ...
            updateShuffle: function (e, t, n) {
                n = n || {};
                if (n.move || !this.preferences.get("shuffle"))
                    return;
            ...
            getNext: function () {
                ...
                if (this.preferences.get("shuffle") && !GS.models.stations.playing()) {
                    var t;
                    if (this._shuffleCurrent < this._shuffled.length - 1)
                        t = this._shuffled[++this._shuffleCurrent];
                    else {
                        if (!this.preferences.get("repeat"))
                            return e;
            ...
            getPrev: function () {
                ...
                if (this.preferences.get("shuffle") && !GS.models.stations.playing()) {
                    ...
                    this._current > 0 && (e = this.at(this._current - 1));
                return e
            },
            prev: function () {
                var e = this.getPrev();
...
function (e, t) {
    ...
    _.extend(_.extend(n.prototype, Backbone.Events), {
        ...
        initialize: function () {
            this.errorReset();
            if ($.os.ios || $.os.android && parseInt($.os.version, 10) >= 4)
                this._needsActivated = !0;
    ...
    var n = Backbone.Collection.extend({
        ...
        seed: function () {
            ...
            var e = GS.models.queue,
                t = 0,
                n;
            while (this.length < 7 && t < e.length)
                n = e.at(t++), this.get(n.id) || this.add(n.toJSON());
...
function (e, t) {
    var n = Backbone.View.extend({
        ...
        initialize: function (e) {
            ...
            if (!this.templates.list)
                throw new Error("No idea how to render the List w/o list template");
        ...
        render: function () {
            ...
            if (this._rendered >= e || t.length === 0)
                return;
        ...
        renderAd: function (e) {
            if (this.options.noAd || GS.models.session.isPremium())
                return;
        ...
        r = n.extend({
            ...
            playNow: function (e) {
                if ($(e.target).hasClass("context-menu-button"))
                    return;
                var t = $(e.currentTarget),
                    n = t.data("song-id");
    ...
    var c = Backbone.View.extend({
        ...
        onSort: function (e) {
            if (!e.choice)
                throw new Error("Collection view expects Sort to return a choice");
...
function (e, t) {
    var n = Backbone.View.extend({
        ...
        start: function (t) {
            ...
            if (GS.models.queue.length > 0 && !e.confirm(n))
                return;
...
function (e, t) {
    var n = Backbone.View.extend({
        ...
        remove: function () {
            for (var e = 0; e < this.lists.length; e++)
                this.lists[e].destroy();
...
function (e, t) {
    ...
    var s = Backbone.View.extend({
        ...
        initialize: function (e) {
            if (!e.collection)
                throw new Error("No idea how to show user followers w/o a collection");
    ...
    var o = Backbone.View.extend({
        ...
        initialize: function () {
            if (!(this.options.model instanceof GS.models.User))
                throw new Error("Profile page expects this.options.model to be instance of User model");
        ...
        renderList: function () {
            ...
            if (GS.models.session.isPremium())
                return;
...
function (e, t) {
    var n = Backbone.View.extend({
        ...
        showQueue: function (e) {
            if (this.$state && e.target === this.$state[0])
                return !0;
            GS.h.navigate("/queue")
        },
...
function (e, t) {
    ...
    var u = Backbone.View.extend({
        ...
        initialize: function (e) {
            if (!this.options.makeURL)
                throw new Error("Can't initialize list ads provider w/o makeURL method");
        ...
        placeAd: function (e) {
            if (!e.node)
                throw new Error("No node to place list ad at");
...
function (e, t) {
    var n = Backbone.View.extend({
        ...
        renderRows: function () {
            if (this.lastPageRendered === this.page)
                return;
        ...
        appendRow: function (e, t, n) {
            ...
            if (n.at) {
                ...
                n.at === 0 ? (this.rowCache = {}, this.$list.prepend(r)) : this.$list.append(r);
        ...
        onScroll: function () {
            var t = GS.h.getBodyScrollHeight(),
                ...
                c = r + n >= u && !f;
            if (l || c)
                this.page = Math.max(Math.round((r + n) / t * a), 1), this.renderRowsThrottled();
            this.lastScrolled = r
        },
        events: {
        ...
        i = Backbone.View.extend({
            ...
            play: function (e) {
                if (this._loading || this.collection.length === 0)
                    return;
                var t = this.collection.current();
